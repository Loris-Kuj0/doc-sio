...
La conservation des donnees ne releve pas uniquement d'un choix technique, mais d'un cadre reglementaire strict impose par l'Etat francais (RGPD, Code de commerce, Code du travail). Les organisations ont l'obligation de conserver certains documents pour des durees minimales.
...
cd /tmp && wget https://downloads.rclone.org/rclone-current-linux-amd64.zip && unzip rclone-current-linux-amd64.zip
